// Admin Main JavaScript file for the application
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle dynamic navigation for admin
    ...
    if (mainContent) {
        ...
        fetch(url)
            ...
            .then(html => {
                ...
                initializeAdminBootstrapComponents();
            })
            .catch(error => {
                console.error('Error:', error);
                mainContent.classList.remove('loading');
                showAdminErrorMessage('Failed to load content. Please try again.');
            });
    }
}

function initializeAdminBootstrapComponents() {
