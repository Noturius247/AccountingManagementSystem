...
<head>
    ...
    <title>Pending Student Registrations - Admin Dashboard</title>
        ...
        <c:forEach items="${pendingStudents}" var="student">
            <div class="registration-card">
                ...
                <div class="action-buttons">
                    <form action="/admin/students/approve/${student.id}" method="post" style="display: inline;">
                ...
                <div id="rejectForm${student.id}" class="reject-form">
                    <form action="/admin/students/reject/${student.id}" method="post">
                        <div class="mb-3">
