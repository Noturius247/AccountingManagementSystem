...
<body>
    ...
    <div class="manager-dashboard">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <h3>Active Kiosks</h3>
                <p>${statistics.activeKiosks}</p>
            </div>
            <div class="stat-card">
                <h3>Current Queue</h3>
                <p>${statistics.currentQueue}</p>
            </div>
            <div class="stat-card">
                <h3>Today's Transactions</h3>
                <p>${statistics.todaysTransactions}</p>
            </div>
            <div class="stat-card">
                <h3>Active Users</h3>
        ...
        <div class="charts-container">
            <div class="chart-wrapper">
                <canvas class="manager-chart" data-chart-type="bar" data-chart-data='${chartData.transactionsByMonth}'></canvas>
            </div>
            <div class="chart-wrapper">
                <canvas class="manager-chart" data-chart-type="pie" data-chart-data='${chartData.transactionsByType}'></canvas>
            </div>
        </div>
        ...
        <div class="current-queue">
            ...
            <table class="manager-table">
                ...
                <tbody>
                    <tr>
                        <td>${currentQueue.queueNumber}</td>
                        <td>${currentQueue.type}</td>
                        <td>${currentQueue.priority}</td>
                        <td>${currentQueue.position}</td>
                        <td>${currentQueue.status}</td>
                    </tr>
                </tbody>
            </table>
        </div>
